...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      if (!gl) {
        throw new Error("Não foi possível obter o contexto WebGL.");
      }
      // Forçar tipo correto para gl
      const glWebGL = gl as WebGLRenderingContext | WebGL2RenderingContext;
      let halfFloat;
      let supportLinearFiltering;
      if (isWebGL2) {
        glWebGL.getExtension("EXT_color_buffer_float");
        supportLinearFiltering = glWebGL.getExtension("OES_texture_float_linear");
      } else {
        halfFloat = glWebGL.getExtension("OES_texture_half_float");
        supportLinearFiltering = glWebGL.getExtension(
          "OES_texture_half_float_linear"
        );
      }
      glWebGL.clearColor(0.0, 0.0, 0.0, 1.0);
      const halfFloatTexType = isWebGL2
        ? (glWebGL as WebGL2RenderingContext).HALF_FLOAT
      ...
      if (isWebGL2) {
        formatRGBA = getSupportedFormat(
          glWebGL,
          (glWebGL as WebGL2RenderingContext).RGBA16F,
          glWebGL.RGBA,
          halfFloatTexType
        );
        formatRG = getSupportedFormat(glWebGL, (glWebGL as WebGL2RenderingContext).RG16F, glWebGL.RG, halfFloatTexType);
        formatR = getSupportedFormat(glWebGL, (glWebGL as WebGL2RenderingContext).R16F, (glWebGL as WebGL2RenderingContext).RED, halfFloatTexType);
      } else {
        formatRGBA = getSupportedFormat(glWebGL, glWebGL.RGBA, glWebGL.RGBA, halfFloatTexType);
        formatRG = getSupportedFormat(glWebGL, glWebGL.RGBA, glWebGL.RGBA, halfFloatTexType);
        formatR = getSupportedFormat(glWebGL, glWebGL.RGBA, glWebGL.RGBA, halfFloatTexType);
      }
    ...
    let dye: { texelSizeX: any; texelSizeY: any; read: any; write: any; swap: any; width?: any; height?: any; }, velocity: { texelSizeX: any; texelSizeY: any; read: any; write: any; swap: any; width?: any; height?: any; }, divergence: { attach: any; texture?: any; fbo?: any; width?: any; height?: any; texelSizeX?: number; texelSizeY?: number; }, curl: { attach: any; texture?: any; fbo?: any; width?: any; height?: any; texelSizeX?: number; texelSizeY?: number; }, pressure: { read: any; write: any; swap: any; width?: any; height?: any; texelSizeX?: number; texelSizeY?: number; };
    ...
    function createFBO(w: number, h: number, internalFormat: any, format: any, type: any, param: any): {
      ...
      return {
        ...
        swap: () => {}, // dummy para compatibilidade
      };
    }
    ...
    function resizeFBO(target: ReturnType<typeof createFBO>, w: any, h: any, internalFormat: any, format: any, type: any, param: any) {
    ...
    function clickSplat(pointer: { texcoordX: any; texcoordY: any; }) {
    ...
    function splat(x: any, y: any, dx: number, dy: number, color: { r: any; g: any; b: any; }) {
      splatProgram.bind();
    ...
    function updatePointerMoveData(pointer: { prevTexcoordX: number; texcoordX: number; prevTexcoordY: number; texcoordY: number; deltaX: number; deltaY: number; moved: boolean; color: any; }, posX: number, posY: number, color: { r: any; g: any; b: any; }) {
      pointer.prevTexcoordX = pointer.texcoordX;
      pointer.prevTexcoordY = pointer.texcoordY;
      pointer.texcoordX = posX / canvas.width;
      pointer.texcoordY = 1.0 - posY / canvas.height;
